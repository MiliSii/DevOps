...
Created 2 webhook on Mavan Project (on github: https://github.com/MiliSii/HelloWorld.git). First push request with github_webhook and secund pull request with generic-webhook-trigger.
